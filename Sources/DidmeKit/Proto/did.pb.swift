...
public enum Didme_KeyType: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  case multikey // = 1
  case p256Key2024 // = 2
  case mldsa87Key2024 // = 3
  case mlkem1024Key2024 // = 4
  ...
  public init?(rawValue: Int) {
    ...
    case 2: self = .p256Key2024
    case 3: self = .mldsa87Key2024
    case 4: self = .mlkem1024Key2024
  ...
  public var rawValue: Int {
    ...
    case .p256Key2024: return 2
    case .mldsa87Key2024: return 3
    case .mlkem1024Key2024: return 4
...
extension Didme_KeyType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0KEYTYPE_UNSPECIFIED\0\u{1}MULTIKEY\0\u{1}P256KEY2024\0\u{1}MLDSA87KEY2024\0\u{1}MLKEM1024KEY2024\0")
}
...
extension Didme_DIDDocument: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{1}controller\0\u{1}ctx\0\u{1}also\0\u{1}biometric\0\u{1}hardware\0\u{3}device_model\0\u{1}seq\0\u{1}prev\0\u{1}core\0\u{3}core_cbor\0\u{3}key_history\0\u{1}vm\0\u{1}authn\0\u{1}assert\0\u{1}inv\0\u{1}ka\0\u{1}svc\0\u{1}policy\0\u{1}att\0\u{1}proof\0\u{1}dv\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 9: try { try decoder.decodeSingularStringField(value: &_storage._prev) }()
        case 10: try { try decoder.decodeSingularStringField(value: &_storage._core) }()
        case 11: try { try decoder.decodeSingularBytesField(value: &_storage._coreCbor) }()
        case 12: try { try decoder.decodeRepeatedStringField(value: &_storage._keyHistory) }()
        case 13: try { try decoder.decodeRepeatedMessageField(value: &_storage._vm) }()
        case 14: try { try decoder.decodeRepeatedStringField(value: &_storage._authn) }()
        case 15: try { try decoder.decodeRepeatedStringField(value: &_storage._assert) }()
        case 16: try { try decoder.decodeRepeatedStringField(value: &_storage._inv) }()
        case 17: try { try decoder.decodeRepeatedStringField(value: &_storage._ka) }()
        case 18: try { try decoder.decodeRepeatedMessageField(value: &_storage._svc) }()
        case 19: try { try decoder.decodeSingularMessageField(value: &_storage._policy) }()
        case 20: try { try decoder.decodeRepeatedMessageField(value: &_storage._att) }()
        case 21: try { try decoder.decodeSingularMessageField(value: &_storage._proof) }()
        case 22: try { try decoder.decodeRepeatedMessageField(value: &_storage._dv) }()
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._prev.isEmpty {
        try visitor.visitSingularStringField(value: _storage._prev, fieldNumber: 9)
      }
      if !_storage._core.isEmpty {
        try visitor.visitSingularStringField(value: _storage._core, fieldNumber: 10)
      }
      if !_storage._coreCbor.isEmpty {
        try visitor.visitSingularBytesField(value: _storage._coreCbor, fieldNumber: 11)
      }
      if !_storage._keyHistory.isEmpty {
        try visitor.visitRepeatedStringField(value: _storage._keyHistory, fieldNumber: 12)
      }
      if !_storage._vm.isEmpty {
        try visitor.visitRepeatedMessageField(value: _storage._vm, fieldNumber: 13)
      }
      if !_storage._authn.isEmpty {
        try visitor.visitRepeatedStringField(value: _storage._authn, fieldNumber: 14)
      }
      if !_storage._assert.isEmpty {
        try visitor.visitRepeatedStringField(value: _storage._assert, fieldNumber: 15)
      }
      if !_storage._inv.isEmpty {
        try visitor.visitRepeatedStringField(value: _storage._inv, fieldNumber: 16)
      }
      if !_storage._ka.isEmpty {
        try visitor.visitRepeatedStringField(value: _storage._ka, fieldNumber: 17)
      }
      if !_storage._svc.isEmpty {
        try visitor.visitRepeatedMessageField(value: _storage._svc, fieldNumber: 18)
      }
      try { if let v = _storage._policy {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 19)
      } }()
      if !_storage._att.isEmpty {
        try visitor.visitRepeatedMessageField(value: _storage._att, fieldNumber: 20)
      }
      try { if let v = _storage._proof {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 21)
      } }()
      if !_storage._dv.isEmpty {
        try visitor.visitRepeatedMessageField(value: _storage._dv, fieldNumber: 22)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  }
