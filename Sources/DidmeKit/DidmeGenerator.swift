...
public enum DIDGenerator {
    ...
    public static func create(input: Input) throws -> Output {
        ...
        let document = DIDDocument(
            ...
            id: did,
            controller: did,
            alsoKnownAs: input.alsoKnownAs.isEmpty ? nil : input.alsoKnownAs,
            sequence: sequence,
            prev: prevCid,
            hardwareBound: km.isHardwareBacked ? true : nil,
            biometricProtected: km.isBiometricProtected ? true : nil,
